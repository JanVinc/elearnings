...
<main>
    ...
    <section class="course-content">
        ...
        <p>Geometry is the study of shapes, sizes, and the properties of space. In this course, we will cover topics like:</p>
        <ul>
            <li>Points, Lines, and Planes</li>
            <li>Angles and Their Types</li>
            <li>Triangles and Their Properties</li>
            <li>Perimeter and Area of Basic Shapes</li>
        </ul>
    </section>
